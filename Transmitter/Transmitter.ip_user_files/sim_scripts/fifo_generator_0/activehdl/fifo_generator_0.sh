...
#
# Script generated by Vivado on Wed Jan 29 00:53:52 +0530 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="H:/Users/Pravindu/Xilinx/UART_Module/Transmitter/Transmitter.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
