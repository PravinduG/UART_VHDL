...
#
# Script generated by Vivado on Fri Jan 31 23:49:40 +0530 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="H:/Users/Pravindu/Xilinx/UART_Module/Receiver/Receiver.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
