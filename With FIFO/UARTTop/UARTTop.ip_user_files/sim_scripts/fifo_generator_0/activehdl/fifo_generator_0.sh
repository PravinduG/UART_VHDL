...
#
# Script generated by Vivado on Fri Jan 31 23:50:58 +0530 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="H:/Users/Pravindu/Xilinx/UART_Module/UARTTop/UARTTop.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
